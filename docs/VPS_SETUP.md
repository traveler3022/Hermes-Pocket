...
> [!NOTE]
> اگر بعداً ترجیح دادی گواهی معتبر (امضا شده توسط CA) داشته باشی، باید یه نام دامنه تهیه کنی که به IP سرورت اشاره کنه و بعد با ابزارهای مدیریت گواهی (مثل certbot یا Caddy) گواهی رایگان بگیری. انتخاب ارائه‌دهنده دامنه و ابزار مدیریت گواهی کاملاً سلیقه‌ خودته.
